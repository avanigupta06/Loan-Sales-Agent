...
| POST | `/upload` | Upload salary slip |
| GET | `/generate-pdf/{session_id}` | Download sanction letter PDF |
| GET | `/mock/crm/{phone}` | Mock CRM API |
| GET | `/mock/credit-bureau/{phone}` | Mock Credit Bureau |
| GET | `/mock/offer-mart/{phone}` | Mock Offer Mart |
| GET | `/mock/customers` | List all demo customers |
...
{
  "session_id": "abc123...",
  "message": "👋 Welcome to Tata Capital! I'm Priya...",
  "stage": "collect_phone",
  "agent": "master",
...
### GET /mock/credit-bureau/9876543210
```json
{
  "phone": "9876543210",
  "credit_score": 762,
